package com.argano.digital.jpaexample.configuration;
...
public class SwaggerConfiguration {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Spring Boot with JPA Configuration Sample API")
				.description("This is the documentation for Spring Boot with JPA Sample API service.").license("")
	...
	public Docket customImplementation() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.argano.digital.jpaexample.controller")).build()
